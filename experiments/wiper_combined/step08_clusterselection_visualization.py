...
if __name__ == '__main__':
    ...
    animation_fig = animation.FuncAnimation(fig, update, frames=100//nth_frame, interval=int(30*nth_frame*slow_down), blit=True,
                                            repeat_delay=10, )

    animation_fig.save("C://Users//Vincent//code//motionsegment//data//wiper_combined//motionsegment2.gif")
