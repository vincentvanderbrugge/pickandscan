...
args.img_dir = '..//..//data//mustard8//color'
...
args.pred_seg_dir = 'C://Users//Vincent//code//motionsegment//data//output//mustard8_masks'
...
for file in tqdm(glob.glob(args.img_dir + '/*')):
    ...
    mask_img[seg_result != 0] = 0
    imsave(os.path.join(args.pred_seg_dir, 'mask_visualizations', fname + '.png'), mask_visualization.astype(np.uint8))
    imsave(os.path.join(args.pred_seg_dir, 'masks', fname + '.png'), mask_img.astype(np.uint8))
