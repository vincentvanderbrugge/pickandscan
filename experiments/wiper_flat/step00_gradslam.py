...
if __name__ == "__main__":
    ...
    output_dir = 'C://Users//Vincent//code//motionsegment//data//wiper_flat//process_dir'

    cfg = load_dataset_config(
        "C://Users//Vincent//code//motionsegment//data//wiper_flat//dataconfig.yaml"
    )
    dataset = Record3DDataset(
        config_dict=cfg,
        basedir="C://Users//Vincent//code//motionsegment//data//wiper_flat",
        sequence="sequence0",
        start=0,
        end=-1,
        stride=1,
